<?php
    ...
    class School {
        ...
        private $address;
        private $city;
        private $inStateTuition;
        private $outStateTuition;
        private $inStateCoeff;
        private $outStateCoeff;
        ...
        public function __construct($id, $unitID, $institution, $zipCode, $address, $city, $in14, $out14, $in13, $out13, $in12, $out12, $in11, $out11, $in10, $out10, $in9, $out9, $in8, $out8, $in7, $out7, $in6, $out6, $in5, $out5, $in4, $out4, $in3, $out3, $in2, $out2) {
            ...
            $this->city = $city;
            storeTuitionData("in", $in14, $in13, $in12, $in11, $in10, $in9, $in8, $in7, $in6, $in5, $in4, $in3, $in2);
            storeTuitionData("out", $out14, $out13, $out12, $out11, $out10, $out9, $out8, $out7, $out6, $out5, $out4, $out3, $out2);
            calcCoeffs(); // ***MOVE THIS FUNCTION CALL OUTSIDE CONSTRUCTOR***
            echo "Newman is a bitch";
        }
